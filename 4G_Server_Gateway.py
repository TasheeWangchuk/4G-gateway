# Gateway for CNDingtek kindes sensor 4G LTE version gateway
# change log Nov 19, 2024. change the created threading not close automatically.
# coding:utf-8
    ...
    try:
        ...
        while True:
            ...
            if not request_bytes:
                ...
                break
                # client.close()
            request_str = str(request_bytes)[2:-1]
        ...
        if data_type == "01":
            attr_result, token_id = df703.DF703.parse_data_DF703(str_subreq.strip().upper())
        else :
            if data_type == "31":
